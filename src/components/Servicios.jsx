    ...
    <div className="services-container">
      ...
      <div className="services-items-container">
        <div className="service-item">
          <img src="/corte1.png" alt="Corte de Pelo" className="service-image" />
        ...
        <div className="service-item">
          <img src="/arreglo1.png" alt="Arreglo de barba" className="service-image" />
          <div className="service-description">
        ...
        <div className="service-item">
          <img src="/afeitado1.png" alt="Afeitado de barba" className="service-image" />
          <div className="service-description">
        ...
        <div className="service-item">
          <img src="/tinte1.png" alt="Color de barba" className="service-image" />
          <div className="service-description">
